...
/**
 * Maps `JanitorixMediaAudit\Foo\Bar` onto `src/Foo/Bar.php`, PSR-4 style.
 */
final class Autoloader {

	private const PREFIX = 'JanitorixMediaAudit\\';
	...
	public static function load( string $class_name ): void {
		...
		$path     = JANITORIX_PATH . 'src/' . str_replace( '\\', '/', $relative ) . '.php';

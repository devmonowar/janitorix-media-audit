 ...
 *     why `janitorix_scan_references` is a normalised table rather than a JSON blob:
...
final class Tables {
	...
	private const VERSION_OPTION = 'janitorix_schema_version';

	/** One row per scan run. */
	public static function scans(): string {
		global $wpdb;

		return $wpdb->prefix . 'janitorix_scans';
	}
	...
	public static function references(): string {
		...
		return $wpdb->prefix . 'janitorix_scan_references';
	}
	...
	public static function reports(): string {
		...
		return $wpdb->prefix . 'janitorix_image_reports';
	}
	...
	public static function logs(): string {
		...
		return $wpdb->prefix . 'janitorix_logs';
	}
	...
	public static function manifests(): string {
		...
		return $wpdb->prefix . 'janitorix_restore_manifests';
	}

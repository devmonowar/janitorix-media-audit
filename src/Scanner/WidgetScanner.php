...
final class WidgetScanner implements Scanner {
	...
	public function scan( AttachmentResolver $resolver ): ScannerResult {
		...
		// phpcs:disable WordPress.DB.PreparedSQLPlaceholders.LikeWildcardsInQuery -- 'widget_%%' is a literal option-name prefix, no variable involved; %% is prepare()'s own escaping for one literal percent sign.

...
namespace JanitorixMediaAudit\Confidence;

use JanitorixMediaAudit\Reports\ImageReport;
use JanitorixMediaAudit\Scanner\ScannerResult;
...
final class ConfidenceEngine {
	...
	/**
	 * Formula B's result for this scan — the score every image with no evidence
	 * was given. A property of the scan, so the scan row stores it and the
	 * Dashboard reads it back rather than recomputing it.
	 */
	public function absence_confidence(): int {
		return $this->confidence_of_absence();
	}

...
if ( ! class_exists( 'JanitorixMediaAudit\\Core\\Plugin' ) ) {
	fwrite( STDERR, "Janitorix Media Audit is not active on this site.\n" );
	exit( 1 );
}

$plugin     = JanitorixMediaAudit\Core\Plugin::instance();
